...
const ContextValue = () => {
  ...
  return (
    <div>
      ...
      <div class="grid grid-cols-[1fr_2fr_1fr] grid-rows-[auto_1fr_auto] h-screen gap 2.5">
        <div class="grid justify-center align-center p-2.5 text-2xl border borderblack">
